...
class TestProductModel(unittest.TestCase):
    ...
    def test_read_a_product(self):
        """It should read a product and return its properties"""
        product = ProductFactory()
        product.id = None
        product.create()
        self.assertIsNotNone(product.id)
    ...
    def test_update_a_product(self):
        """It should update a product and its properties"""
        product = ProductFactory()
        product.id = None
        product.create()
        self.assertIsNotNone(product.id)
    ...
    def test_delete_a_product(self):
        """It should delete the product selected"""
        product = ProductFactory()
        product.create()
    ...
    def test_find_a_product_by_availability(self):
        """It should find a product by its Availability value"""
